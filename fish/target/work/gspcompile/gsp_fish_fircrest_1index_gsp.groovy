...
class gsp_fish_fircrest_1index_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fircrest_1/index.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('captureBody','sitemesh',455,['id':("page-top"),'data-spy':("scroll"),'data-target':(".navbar-custom")],1)
printHtmlPart(7)
}
...
public static final long LAST_MODIFIED = 1420340841000L
