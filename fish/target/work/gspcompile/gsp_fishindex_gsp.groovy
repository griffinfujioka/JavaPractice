...
class gsp_fishindex_gsp extends GroovyPage {
...
invokeTag('ifAllGranted','sec',88,['roles':("ROLE_USER")],2)
printHtmlPart(12)
})
invokeTag('captureBody','sitemesh',587,['id':("page-top"),'class':("index")],1)
printHtmlPart(13)
}
...
public static final long LAST_MODIFIED = 1419107332000L
