                    ...
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Fish is a free application that helps marijuana enthusiasts connect with other users in their community quickly, legally, and most importantly, safely.</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Simply tell us how much marijuana you have, the strain's name/type, plus a preferred search radius and we'll connect you with trusted marijuana smokers in you area looking to meet and smoke. </p>
                                </div>
                            </div>
                        </li>
                    </ul>
