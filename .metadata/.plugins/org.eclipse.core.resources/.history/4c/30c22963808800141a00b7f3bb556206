	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="navbar-header page-scroll">
				...
				<a class="navbar-brand page-scroll" href="#page-top">fish</a>
			</div>
	...
	<header>
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in">fish</div>
				<div class="intro-heading">Tinder for stoners</div>
				<div>
				...
				<div class="col-lg-12">
					<ul class="timeline">
						<li>
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4 class="subheading">Let's go fishing</h4>
								</div>
								<div class="timeline-body">
									<p class="text-muted">Fish is a free application that helps
										marijuana enthusiasts connect with other users in their
										community quickly, legally, and most importantly, safely.</p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4 class="subheading">How fish Works</h4>
								</div>
								<div class="timeline-body">
									<p class="text-muted">Simply tell us how much marijuana you
										have, the strain's name/type, plus a preferred search radius
										and we'll connect you with trusted marijuana smokers in you
										area looking to meet and smoke.</p>
								</div>
							</div>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="team-member">
						<img src="img/team/noah.jpg" class="img-responsive img-circle"
							alt="">
						<h4>Noah Benesch</h4>
						<p class="text-muted">Founder, CEO</p>
						<ul class="list-inline social-buttons">
							<li><a href="https://twitter.com/NoahTBenesch"><i
				...
				<div class="col-sm-4">
					<div class="team-member">
						<img src="img/team/hatch.png" class="img-responsive img-circle"
							alt="">
						<h4>Hatch Miller</h4>
				...
				<div class="col-sm-4">
					<div class="team-member">
						<img src="img/team/griffin.jpg" class="img-responsive img-circle"
							alt="">
						<h4>Griffin Fujioka</h4>
						<p class="text-muted">Founder, Developer</p>
						<ul class="list-inline social-buttons">
							<li><a href="http://www.twitter.com/griffinfujioka"><i
									class="fa fa-twitter"></i></a></li>
							<li><a
								href="http://www.linkedin.com/pub/griffin-fujioka/19/12b/b59/"><i
